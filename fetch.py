#!/usr/bin/env python3
"""
Recupero codici sconto Photosi da shopilo.it
Sursa: https://shopilo.it/negozi/photosi.com
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/photosi.com"
STORE_NAME = "Photosi"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Photosi da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-photosi)"
    }
    try:
